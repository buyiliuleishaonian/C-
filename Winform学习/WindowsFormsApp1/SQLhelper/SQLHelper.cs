...
namespace WindowsFormsApp1
{
    ...
    public class SQLHelper
    {
        ...
        public static string sql1 = ConfigurationManager.ConnectionStrings["sqlStr"].ToString();
        //通过输入来得到数据库
        private static string sql2 = "server=.;uid=jgw;password=123456;database=学生学习系统管理DB";

        public static string sql3 = ConfigurationManager.ConnectionStrings["sql"].ToString();
        ...
        public static DataTable GetDataTable(string sql, params SqlParameter[] sq)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(sql3))
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand(sql, con);
                    cmd.Parameters.AddRange(sq);
        ...
        /// <summary>
        /// 执行SQL中的显示事务，只执行insert，update，delete，修改表的结果的事务
        /// </summary>
